			...
			<div class="main container">
				...
				<div class="container">
					...
					<div class="payMethod row">
						...
						<label class="radio-inline">
						      <a href="https://excashier.alipaydev.com/standard/auth.htm?payOrderId=b275e75b5b0b41f6ba5372f445337cb8.00">
							<input type="radio" name="paymeth" id="inlineRadio1" checked="checked" value="option1">支付宝支付
					</a>
						</label>
						<!-- <label class="radio-inline">
						  	<input type="radio" name="paymeth" id="inlineRadio3" value="option3"> 货到付款
						...
						<label class="radio-inline">
							...
							<input type="radio" name="paymeth" id="inlineRadio1" checked="checked" value="option1">微信支付
